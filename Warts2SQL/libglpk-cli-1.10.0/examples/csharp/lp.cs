...
class Program
{
    ...
    {int ret;
            ...
            try
            {
                ...
                GLPK.glp_set_col_bnds(lp, 1, GLPK.GLP_LO, 0, .5);
                GLPK.glp_set_col_name(lp, 2, "x2");
                GLPK.glp_set_col_kind(lp, 2, GLPK.GLP_CV);
                GLPK.glp_set_col_bnds(lp, 2, GLPK.GLP_LO, 0, .5);
                GLPK.glp_set_col_name(lp, 3, "x3");
                GLPK.glp_set_col_kind(lp, 3, GLPK.GLP_CV);
                GLPK.glp_set_col_bnds(lp, 3, GLPK.GLP_LO, 0, .5);
                ...
                GLPK.glp_set_row_bnds(lp, 3, GLPK.GLP_UP, 0, 0.8);
                GLPK.intArray_setitem(ind, 1, 1);
                GLPK.intArray_setitem(ind, 2, 2);
                GLPK.intArray_setitem(ind, 3, 3);
                GLPK.doubleArray_setitem(val, 1, 1.0);
