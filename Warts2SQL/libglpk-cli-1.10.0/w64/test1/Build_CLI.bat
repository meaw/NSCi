...
set VCL="C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin"

set PATH=%VCL%;%NET%;%PATH%
cd ..\swig-cli
mkdir src\csharp
mkdir src\c
copy *.cs src\csharp
...
set INCLUDE=
%set INCLUDE=C:\Program Files (x86)\Windows Kits\10\Include\10.0.14393.0\ucrt;C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\include
set LIB=
